...
public class CoffeeDashboard2 extends JFrame {
    private JTable jTable;
    private DefaultTableModel tableModel;

    public CoffeeDashboard2() {
        CoffeeDashboard coffeeDashboard = new CoffeeDashboard();
        initComponents();
        fetchData();
    }
    ...
    private void initComponents() {
        ...
        tableModel = new DefaultTableModel(new Object[]{"Product Name", "Product Price", "Product Quantity","Product Size" ,"Product Total"}, 0);
    ...
    private void fetchData() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                double total = rs.getDouble("TotalCoffeePrice");
